          ...
          <div className="bg-white dark:bg-[var(--bg-secondary)] p-6 rounded-xl shadow-md lg:col-span-2">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex space-x-2">
                <button className="px-3 py-1 text-xs bg-blue-50 dark:bg-[var(--primary-color)] dark:text-white text-blue-600 rounded-full">This Week</button>
                <button className="px-3 py-1 text-xs bg-gray-50 dark:bg-[var(--primary-color)] dark:text-white text-gray-600 rounded-full">Last Week</button>
              </div>
            </div>
